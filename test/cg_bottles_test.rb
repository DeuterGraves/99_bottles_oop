...
require_relative '../lib/cg_bottles'
...
class CgBottlesTest < Minitest::Test
  ...
  def test_another_verse
    ...
    assert_equal expected, CgBottles.new.verse(3)
  end
  ...
  def test_verse_2
    ...
    assert_equal expected, CgBottles.new.verse(2)
  end
  ...
  def test_a_couple_verses
    ...
    assert_equal expected, CgBottles.new.verses(99, 98)
  end
  ...
  def test_the_whole_song
    ...
    assert_equal expected, CgBottles.new.song
  end
end